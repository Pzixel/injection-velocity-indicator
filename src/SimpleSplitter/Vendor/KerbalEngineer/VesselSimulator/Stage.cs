...
namespace SimpleSplitter.Engineer.VesselSimulator
{
    public class Stage
    {
        // Simple Splitter: retain the chronological engine/resource intervals.
        internal readonly System.Collections.Generic.List<EngineerSegment> burnSegments =
            new System.Collections.Generic.List<EngineerSegment>();
